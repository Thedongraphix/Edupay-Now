        ...
        <div className="border-b border-gray-200 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ReceiptItem
              ...
              label="Amount Paid"
              value={receiptData?.amountPaid?.toLocaleString('en-US', { style: 'currency', currency: 'USD' }) ?? '$2400'}
            />
            <ReceiptItem
              icon={<FaCalendarAlt className="text-blue-500" />}
              label="Date"
              value={receiptData?.date ?? '3rd Oct.24'}
            />
            <ReceiptItem
              icon={<FaIdCard className="text-blue-500" />}
              label="Transaction ID"
              value={receiptData?.transactionId ?? '12345'}
            />
            <ReceiptItem
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <ReceiptItem
              icon={<FaIdCard className="text-blue-500" />}
              label="Student ID"
              value={receiptData?.studentId ?? '1234'}
            />
          </div>
        </div>
      </div>
